...
- The release zip, such as `RGFrontend-H700-1.0.0.zip`.
...
2. Copy `RGFrontend-H700-1.0.0.zip` to the TF card root.

   Correct location example:

   ```text
   TF card root/RGFrontend-H700-1.0.0.zip
   TF card root/Roms/
   ```
...
```text
TF card root/RGFrontend-H700-1.0.0/Roms/APPS/...
```
