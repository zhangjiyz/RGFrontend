...
- 一台 H700 原厂 Linux 掌机。
- 一张已能被掌机识别的 ROM 卡。
- release zip，例如 `RGFrontend-H700-1.0.2.zip`。
...
2. 把 `RGFrontend-H700-1.0.2.zip` 复制到 TF 卡根目录。

   正确位置示例：

   ```text
   TF卡根目录/RGFrontend-H700-1.0.2.zip
   TF卡根目录/Roms/
   ```
...
```text
TF卡根目录/RGFrontend-H700-1.0.2/Roms/APPS/...
```
